...
class CustomerControllerTest {
    ...
    @Captor
    ArgumentCaptor<CustomerDTO> beerArgumentCaptor;
    ...
    void testPatchCustomer() throws Exception {
        ...
        verify(customerService).patchCustomer(uuidArgumentCaptor.capture(), beerArgumentCaptor.capture());

        assertThat(customer.getId()).isEqualTo(uuidArgumentCaptor.getValue());
        assertThat(customerMap.get("name")).isEqualTo(beerArgumentCaptor.getValue().getName());
    }
    ...
    void getCustomerByIdNotFound() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.CUSTOMER_BY_ID, UUID.randomUUID()))
